...
import { TextVerifiedComponent } from './text-verified.component';
...
describe('TextVerifiedComponent', () => {
  let component: TextVerifiedComponent;
  let fixture: ComponentFixture<TextVerifiedComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ TextVerifiedComponent, DsDatePipe ]
    })
    .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(TextVerifiedComponent);
